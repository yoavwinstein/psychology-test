...
app.post('/post', bodyParser.json(), function (req, res) {
    ...
    let header = ['זמן תגובה', 'תשובה נכונה / טעות', 'אות המטרה שהוצגה', 'האות שהושמעה', 'מספר סדרתי של אות מטרה', 'מספר בלוק', 'האם נבחן צדק', 'מספר סידורי בבחינה', 'תנאי', 'אימון / מבחן', 'התשובה הנכונה', 'התשובה בפועל', 'אחוז תשובות נכונות', 'מין', 'שנה'];
